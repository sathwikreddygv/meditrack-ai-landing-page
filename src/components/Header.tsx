        ...
        <nav className="hidden md:flex items-center gap-6">
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
              <div className="py-2">
                <a href="#" className="block px-4 py-2 hover:bg-primary/10 transition-colors">Anxiety Check</a>
                <a href="#" className="block px-4 py-2 hover:bg-primary/10 transition-colors">Depression Screening</a>
                <a href="#" className="block px-4 py-2 hover:bg-primary/10 transition-colors">Stress Assessment</a>
              </div>
            </div>
          </div>
