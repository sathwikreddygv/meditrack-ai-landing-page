  ...
  return (
    <div className="container px-4 py-8 md:py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        <Card className="group hover:shadow-lg transition-all animate-fade-in animation-delay-300 hover:scale-105 cursor-pointer">
          <CardHeader>
        ...
        <Card className="group hover:shadow-lg transition-all animate-fade-in animation-delay-400 hover:scale-105 cursor-pointer">
          <CardHeader>
        ...
        <Card className="group hover:shadow-lg transition-all animate-fade-in animation-delay-500 hover:scale-105 cursor-pointer">
          <CardHeader>
        ...
        <Card className="group hover:shadow-lg transition-all animate-fade-in animation-delay-600 hover:scale-105 cursor-pointer">
          <CardHeader>
